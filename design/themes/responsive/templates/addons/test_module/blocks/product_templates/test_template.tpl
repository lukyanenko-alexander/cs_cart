    ...
    {hook name="products:view_main_info"}
        {if $product}
            ...
            <div class="ty-product-block__left">
                ...
                <div class="ty-product-block__sku">
                    <div class="ty-control-group ty-test-item cm-hidden-wrapper{if !$product.test} hidden{/if}" id="test_update_{$obj_prefix}{$obj_id}">
                        <label class="ty-control-group__label" id="test_{$obj_prefix}{$obj_id}">{__("test")}:</label>
                        <span class="ty-control-group__item cm-reload-{$obj_prefix}{$obj_id}" id="test_{$obj_prefix}{$obj_id}">{$product.test}<!--product_code_{$obj_prefix}{$obj_id}--></span>
                    </div>
                </div>
