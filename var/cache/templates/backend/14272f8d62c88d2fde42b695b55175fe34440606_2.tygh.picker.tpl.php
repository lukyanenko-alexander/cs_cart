...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62ec02a0d37d93_82622615',
...
function content_62ec02a0d37d93_82622615 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_subTemplateRender("tygh:pickers/products/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('picker_id'=>((string)$_smarty_tpl->tpl_vars['advanced_picker_id']->value),'data_id'=>"om",'no_container'=>true,'icon'=>"icon-reorder",'but_text'=>$_prefixVariable5,'show_but_text'=>false,'view_mode'=>"button",'meta'=>"object-picker__advanced-btn object-picker__advanced-btn--products ".((string)$_smarty_tpl->tpl_vars['object_picker_advanced_btn_class']->value),'segment'=>$_smarty_tpl->tpl_vars['segment']->value), 0, false);
?>
            </div>
        <?php }?>
...
echo htmlspecialchars(fn_url("products.get_products_list?".$_prefixVariable6.$_prefixVariable7), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars(smarty_modifier_to_json(array(array("id"=>0,"text"=>$_prefixVariable8))), ENT_QUOTES, 'UTF-8');?>
"
                    <?php }?>
            >
                <?php
